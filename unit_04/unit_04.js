...
function f4() {
    document.querySelector('.out-4').innerHTML = document.querySelector('input.i-4').checked
}
...
function f5() {
    const checkbox = document.querySelector('input.i-5');

    document.querySelector('.out-5').innerHTML = checkbox.checked ? checkbox.value : false;
}
...
function f6() {
    document.querySelector('.out-6').innerHTML = document.querySelector('input.i-6').value;
}
...
function f7() {
    const password = document.querySelector('input.i-7').value;

    document.querySelector('.out-71').innerHTML = password;
    document.querySelector('.out-72').innerHTML = password.length >= 6 ? 1 : 0;
}
...
function f8() {
    ...
    divOut8.innerHTML = '<input class="i-81">';
    divOut8.innerHTML += '<button class="button-primary b-81">Push me</button>';

    document.querySelector('button.b-81').onclick = f81;
}

function f81() {
    document.querySelector('.out-81').innerHTML = document.querySelector('input.i-81').value;
}
...
function f9() {
    const radioButton = document.querySelector('input.r-9');
    document.querySelector('.out-9').innerHTML = radioButton.checked ? radioButton.value : 0;
}
...
function f10() {
    document.querySelector('.out-10').style.background = document.querySelector('input.i-10').value;
}
...
function f11() {
    document.querySelector('input.i-112').value = document.querySelector('input.i-111').value;
}
...
function f12() {
    document.querySelector('.out-12').innerHTML = document.querySelector('input.i-12').value;
}
...
function f13() {
    document.querySelector('.out-13').innerHTML = document.querySelector('input.i-13').value;
}
...
function f14() {
    document.querySelector('.out-14').innerHTML = document.querySelector('textarea.t-14').value;
...
function f15() {
    document.querySelector('.out-15').innerHTML = document.querySelector('input.i-15').value;
    document.querySelector('textarea.t-15').innerHTML = document.querySelector('input.i-15').value;
}
...
function f16() {
    ...
    document.querySelector('.out-16').innerHTML = document.querySelector('select.s-16').value;
}
...
function f17() {
    document.querySelector('.out-17').innerHTML = document.querySelector('select.s-17').value;
}
...
function f19() {
    const text = document.querySelector('input.i-191').value;
    const password = document.querySelector('input.i-192').value;

    document.querySelector('.out-19').innerHTML = text + ' ' + password;
}
