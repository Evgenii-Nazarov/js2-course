let a1_res = [], a2_res = [], a3_res = [], a4_res = [], a5_res = [], a6_res = [], a7_res = [], a8_res, a9_res = '',
    a10_res = '';
...
function t4() {
    const nodeList = document.querySelectorAll('span.task-4');

    nodeList.forEach(el => a4_res.push(el.getAttribute('data')))
}
...
function t5(e) {
    const elDataAttribute = e.currentTarget.getAttribute('data');

    a5_res.push(elDataAttribute);
}
...
function t9() {
    ...
    document.querySelector('.out-9').innerHTML = a8_res;
}
