...
document.querySelector('.b-4').onclick = function () {
    document.querySelector('.out-4').textContent = t4(1990);
}
...
document.querySelector('.b-5').onclick = function () {
    document.querySelector('.out-5').textContent = t5('Eugene');
}
...
function t7() {
    const randomX = Math.floor(Math.random() * (251));
    const randomY = Math.floor(Math.random() * (251));
    const randomZ = Math.floor(Math.random() * (251));

    return `rgb(${randomX}, ${randomY}, ${randomZ})`
}
