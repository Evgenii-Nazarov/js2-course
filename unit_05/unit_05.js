...
function t1() {
    ...
    document.querySelector('.out-1').innerHTML = numbers.join(' ');
...
function t4() {
    ...
    document.querySelector('.out-4').innerHTML = numbers;
}
...
function t5() {
    ...
    document.querySelector('.out-5').innerHTML = numbers;
}
...
function t6() {
    const rowNumber = +document.querySelector('input.i-6').value;
    let stars = '';
    ...
    document.querySelector('.out-6').innerHTML = stars;
}
...
function t7() {
    const startNumber = +document.querySelector('input.i-7').value;
    const numbers = [];
    ...
    document.querySelector('.out-7').innerHTML = numbers.join(' ');
}
...
function t8() {
    const startNumber = +document.querySelector('input.i-81').value;
    const endNumber = +document.querySelector('input.i-82').value;
    const numbers = [];
    for (let i = startNumber; i <= endNumber; i++) {
        numbers.push(i);
    }
    document.querySelector('.out-8').innerHTML = numbers.join(' ');
}
...
function t9() {
    ...
    document.querySelector('.out-9').innerHTML = numbers.join(' ');
}
...
function t10() {
    ...
    document.querySelector('.out-10').innerHTML = numbers.join(' ');
}
