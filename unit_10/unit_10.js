...
let ar6 = ['eugene', 'cancer', 20, 7];

function f6() {
    document.querySelector('div.out-6').innerHTML = ar6.join(' ');
}
...
function f7() {
    ...
    document.querySelector('div.out-7').innerHTML = ar7.join(' ');
}
...
function f8() {
    ...
    document.querySelector('div.out-8').innerHTML = ar8.join('-');
...
function f10() {
    document.querySelector('div.out-10').innerHTML = ar10[0] + ar10[ar10.length - 1];
}
...
function f11() {
    ...
    document.querySelector('div.out-11').innerHTML = ar11.join(' ');
}
...
function f12() {
    const temp = ar12[ar12.length - 1];
    ar12[ar12.length - 1] = ar12[0];
    ar12[0] = temp;

    document.querySelector('div.out-12').innerHTML = ar12.join(' ');
}
...
function f13() {
    document.querySelector('div.out-13').innerHTML = ar13.map((el, i) => i + ' ' + el).join(' ');
}
...
function f14() {
    document.querySelector('div.out-14').innerHTML = ar14.reverse().join(' ');
}
...
function f15() {
    document.querySelector('div.out-15').innerHTML = ar15.filter(el => el > 0).join(' ');
}
...
function f16() {
    ...
    ar16.forEach(el => {
        if (el % 2) {
            ar16_even[evenCount] = el;
            evenCount++;
        } else {
            ar16_odd[oddCount] = el;
            oddCount++;
        }
    })
...
function f17() {
    ...
    document.querySelector('div.out-17').innerHTML = count;
}
...
function f19() {
    document.querySelector('div.out-19').innerHTML = Math.min(...ar19);
}
...
function f20() {
    document.querySelector('div.out-20').innerHTML = ar20.reduce((acc, el) => acc + el, 0);
}
