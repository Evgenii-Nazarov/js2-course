...
function f8() {
    const inputValue = document.querySelector('input.i-8').value;
    d8 = [inputValue, ...d8];
    showArr('.out-8', d8);
}
...
function f11() {
    const inputValue = +document.querySelector('input.i-11').value;
    const elIndex = d11.indexOf(inputValue);

    document.querySelector('div.out-11').innerHTML = elIndex;
}
...
function f12() {
    ...
    document.querySelector('div.out-12').innerHTML = elementIndex;
}
...
function f13() {
    const reversedArr = [];
    d13.forEach(el => reversedArr.unshift(el));
    showArr('.out-13', reversedArr);
}
