...
const f4 = () => {
    ...
    document.querySelector('.out-4').innerHTML = s4.has(inputValue);
}
...
const f6 = () => {
    const set = new Set(a6);
    document.querySelector('.out-6').innerHTML = set.size;
}
...
const f7 = () => {
    ...
    const set = new Set(inputValue.split(''));
    document.querySelector('.out-7').innerHTML = set.size === inputValue.length ? 1 : 0;
}
...
const f13 = () => {
    const set = new Set(str13.split(''));
    const arr = str13.split('');
    const obj = {};

    for (let element of set) {
        obj[element] = arr.filter(el => el === element).length
    }
