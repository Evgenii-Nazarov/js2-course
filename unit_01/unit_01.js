...
document.querySelector('.three').innerHTML = '<h3>I did this</h3>';
...
document.querySelector('.four').innerHTML = '<h4>???</h4>';
document.querySelector('.four').innerHTML += '<p>!!!</p>';
...
document.querySelector('.concat').innerHTML = x1 + x2;
...
console.log(divS3); // ну тут вроде понятно. Присвоили, вывели, переприсвоили, опять вывели.
